...
export default function TentangPage() {
    ...
    return (
        <div className="homePage" style={{ paddingTop: '90px' }}>
                    ...
                    >
                        ...
                        <div className="container">
                            <div className="heroTextOverlay">
                                ...
                                <p className="heroSubtitle" style={{ margin: '2rem 0', color: 'var(--text-muted)' }}>
                                    {slide.subtitle}
                                </p>
                                <div className="heroActions">
                                    <Link href="/" className="btn btn-primary">Mulai Belanja</Link>
                                    <Link href="/" className="btn btn-outline">Lihat Koleksi</Link>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="galeri" style={{ padding: '10rem 0' }}>
                <div className="container">
                    ...
                    <div style={{ textAlign: 'center', marginTop: '4rem' }}>
                        <Link href="/" className="btn btn-outline" style={{ padding: '1.2rem 3rem' }}>
                            Mulai Belanja & Pilih Spesimen
                        </Link>
                    </div>
                </div>
            </section>
