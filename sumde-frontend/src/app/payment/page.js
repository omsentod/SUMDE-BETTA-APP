...
export default function PaymentPage() {
    ...
    }, [status, clearCart, cart, currentUser, total, shipment]);
    ...
    if (status === 'success') {
        return (
            <div className="container" style={{ padding: '10rem 0', textAlign: 'center' }}>
                ...
                <p style={{ color: 'var(--text-muted)', marginBottom: '3rem' }}>Garis keturunan telah diamankan. Pengiriman kurir ke <b>{shipment?.streetAddress}, {shipment?.city}</b> sedang dimulai.</p>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
                        ...
                        <div style={{ background: 'rgba(255,255,255,0.02)', padding: '2rem', borderRadius: '1rem', border: '1px solid rgba(255,255,255,0.05)' }}>
                            ...
                            <div style={{ fontSize: '0.9rem', color: 'var(--text-muted)', lineHeight: '1.6' }}>
                                ...
                                <p>{shipment?.phone}</p>
                                <p>{shipment?.streetAddress}, {shipment?.rtRw}</p>
                                <p>Kel. {shipment?.village}, Kec. {shipment?.district}</p>
                                <p>{shipment?.city}, {shipment?.province}, {shipment?.postalCode}</p>
                            </div>
                        </div>
                    </div>
                </div>
