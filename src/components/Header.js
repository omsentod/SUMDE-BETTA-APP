...
// ── ThemeIcon dinonaktifkan sementara bersama toggle theme (mode terang dikunci) ──
        ...
        <>
            <header className="header">
                <div className="container header-container">
                    ...
                    <div className="header-actions">
                        ...
                        {/* Theme toggle (desktop) DINONAKTIFKAN SEMENTARA — app dikunci mode terang.
            ...
            <div className={`mobile-nav-overlay${menuOpen ? ' open' : ''}`}>
                ...
                <nav className="mobile-nav-links">
                    ...
                    {/* Theme toggle (mobile) DINONAKTIFKAN SEMENTARA — app dikunci mode terang.
                        Uncomment blok di bawah (+ import/binding di atas) untuk mengaktifkan lagi.
                    <button
                        type="button"
                        onClick={() => { toggleTheme(); }}
                    ...
                    */}
                    ...
                    {/* Logout — hanya saat login. Desktop pakai profile dropdown (hide-on-mobile),
                        jadi tanpa ini user mobile tidak punya cara keluar dari hamburger. */}
                    {currentUser && (
                        <button
                            type="button"
                            onClick={() => { logout(); closeMenu(); }}
                            className="mobile-nav-link mobile-nav-logout-btn"
                        >
