        ...
        <div className={styles.waybillRow}>
          {waybill && (
            <div className={styles.barcodeWrap}>
              {/* Barcode is generated by an external service (metafloor). Fine
                  for print-preview but a self-hosted bwip-js render would
                  eliminate the external dependency; leaving for a future pass. */}
